...
api_v1_router.include_router(
    scheduler_router, tags=['任务调度'], dependencies=[Depends(check_authority)]
)
api_v1_router.include_router(
    sys_api_router, tags=['服务API管理'], dependencies=[Depends(check_authority)]
)
api_v1_router.include_router(
    sys_casbin_router, tags=['权限API管理'], dependencies=[Depends(check_authority)]
)
